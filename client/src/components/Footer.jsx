    ...
    <footer className="bg-purple-900 text-white py-10 ">
      <div className="container mx-auto flex flex-col md:flex-row justify-start items-start px-4 md:px-15 lg:px-100 space-y-8 md:space-y-0">
        <div className="w-full md:w-2/4 space-x-4 flex flex-col md:flex-row items-start md:items-center mb-8 md:mb-0">
          ...
          <div>
            <Link to="/home" className="text-2xl font-semibold mb-2 hover:text-gray-400 transition-colors duration-300 ">
              Diabetes Prediction
            </Link>
  ...
  This website provides a platform for users to predict their likelihood of developing diabetes based on various factors..
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <ul className="space-y-2 text-lg">
            <li><Link to="/home" className="text-white hover:text-gray-400 transition-colors duration-300">Home</Link></li>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0 md:px-10 lg:px-50">
          ...
          <div className="flex items-center text-gray-400 text-lg mb-4">
            ...
            <a href="#" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">Madurai , Tamilnadu , India</a>
          </div>
          <div className="flex items-center text-gray-400 text-lg mb-4">
            <FaEnvelope className="mr-2 text-2xl" />
            <a href="mailto:dhonisivanath007@gmail.com" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">dhonisivanath007@gmail.com</a>
            
          </div>
          <div className="flex items-center text-gray-400 text-lg">
            <FaPhone className="mr-2" />
            <a href="tel:+9994495686" className="text-gray-400 hover:text-white transition-colors duration-300 cursor-pointer">+919994495686</a>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/4 mb-8 md:mb-0">
          ...
          <div className="flex space-x-4 text-2lg">
            ...
            <a href="https://www.linkedin.com/in/sivanath-babu-v-g-7451b0252/">
              <FaLinkedinIn className="text-2xl" />
            </a>
            <a href="https://github.com/Sivavg" className="text-white hover:text-gray-400 transition-colors duration-300">
      ...
      <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center px-6 md:px-12 lg:px-20">
        ...
        <div>
          ...
          >
            <p>Developed by Sivanath Babu (Siva.vg)</p>
          </a>
        </div>
      </div>
    </footer>
