      ...
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center">
          <motion.span
            ...
            className="mb-2 block text-2xl font-semibold text-indigo-600 dark:text-indigo-400"
          >
            FAQ
          </motion.span>
          <motion.h2
          ...
          <motion.p
            ...
            className="mx-auto max-w-3xl text-gray-500 dark:text-gray-300"
          >
...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <motion.div
      className="mb-8 w-full rounded-lg bg-white p-4 shadow-md dark:bg-gray-700 sm:p-8"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6 }}
    >
